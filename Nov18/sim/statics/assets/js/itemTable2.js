      ...
      '<tr>' +
        '<td>' +
          '<div style="display: flex; gap: 15px;">' +
            ...
            '<i class="bi bi-file-earmark-plus icon-large" style="font-size: 1.6rem; margin-right: 18px;" '+
            'onclick="openModal(null, \'new\')" data-bs-toggle="tooltip" title="Create New"></i>' +

            '<i class="bi bi-pencil-square icon-large" style="font-size: 1.6rem; margin-right: 18px;" '+
            'onclick="openModal(' + d.id + ', \'modify\')" data-bs-toggle="tooltip" title="Modify"></i>' +

            '<i class="bi bi-copy   icon-large" style="font-size: 1.6rem; margin-right: 18px;" '+
            'onclick="openModal(' + d.id + ', \'clone\')"  data-bs-toggle="tooltip" title="Clone"></i>' +
            
            '<i class="bi bi-trash3 icon-large" style="font-size: 1.6rem; margin-right: 18px;" '+
            'onclick="openModal(' + d.id + ', \'delete\')" data-bs-toggle="tooltip" title="Delete"></button> </i> ' +
